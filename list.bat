@echo off& call loadF.bat _checkObjParams _true _false _ifOr _errorMsg _objExtend
...
set %2._field_size=0& set %2._field_object_type=list& set %2._functions=%_list_functions%
